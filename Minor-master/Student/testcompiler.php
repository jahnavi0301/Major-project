...
<div class="header">
     <a href="#" class="logo"><img src="./images/igdtuwLogo.png"></a>
      <a href="#" style="margin-top:50px;  float: left">Indira Gandhi Delhi Technical University for Women</a>
  </div>
...
<div class="row">
    ...
    <form onsubmit="return on_submit()" action="testcompile.php" method="post" id="form1">
        <select class="form-control" name="language_id" style="display:inline-block;position:absolute;top:40%">
...
<div id="testModal" class="testModal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="testcompile.php" method="post" id="formx"> 
