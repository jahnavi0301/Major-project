...
session_start();
$q=$_POST['question'];
$_SESSION['q_selected']=$q;
$l=$_POST['language'];
$_SESSION['language']=$l;
$con=mysqli_connect('localhost','root','');
mysqli_select_db($con,'minorproject1');

$code=$_POST['ace_js_control'];
...
$reg="INSERT INTO qtos_map VALUES (null, '$q_id', '$rollno', '$code', '5') ";
mysqli_query($con,$reg);
$s="SELECT SUBMISSION FROM qtos_map WHERE ROLL='$rollno'&& Q_ID='$q_id'";
