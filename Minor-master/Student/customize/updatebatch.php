...
<form action="updatebatch.php" method="post">
        ...
        <div class="efgh">
            <select name="oldbr" class="form-control">
    ...
    <div class="abcd">
        ...
        <div class="efgh">
            <select name="oldb" class="form-control">
                <?php
                if($_POST['oldbr']) {
                    $_SESSION['oldbr']=$_POST['oldbr'];
                  }
                $branch=$_SESSION['oldbr'];
                $sql="SELECT BATCH FROM batch WHERE BRANCH='$branch'";
...
if(isset($_POST['submit'])) {
    ...
    ?>
        <script>
        window.alert("Please fill Old Batch field!");
        </script>
    <?php
    }
    if($_POST['newb']) {
    ...
    ?>
        <script>
        window.alert("Please fill New Batch field!");
        </script>
    <?php
    }
    ...
    {
        $roll=$_SESSION['roll'];
        $s="SELECT BATCH FROM student_registration WHERE ROLL='$roll'";
        ...
        if($oldb==$row['BATCH'])
        {
            $f= "UPDATE student_registration set BATCH='$newb' where ROLL='$roll'";
        ...
        else
        {
            ?>
                <script>
                window.alert("Incorrect Old Batch");
                </script>
            <?php
        }
    }
